...
{
    public PlayerAIBrains_Feeder_CollectController playerAIBrains_Feeder_CollectController;
    ...
    void _CheckTurn()
    {
        ...
        if (turnType == 1)
        {
            ...
            {
                if (FeederCollectMissionController.instance.collectItemSpawner.collectedItems.Contains(selectedItem))
                {
                    selectedItem = null;
                }
                else
        ...
        {
            playerAIController.aIPath._SetMoveToPosition(FeederCollectMissionController.instance.collector.position);
        }
    }
