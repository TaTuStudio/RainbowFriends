...
public class ImpostorMonsterController : MonoBehaviour
{
    ...
    public Vector3 impostorScale = Vector3.zero;
    public Animator humanAnimator;
    public Vector3 humanScale = Vector3.zero;
    ...
    void _ActiveImpostor(bool active)
    {
        if (active)
        {
            impostorAnimator.transform.localScale = impostorScale;
            humanAnimator.transform.localScale = Vector3.zero;
        }
        else
        {
            impostorAnimator.transform.localScale = Vector3.zero;
